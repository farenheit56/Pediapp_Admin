    ...
    <q-card-section class="q-pa-none">
      <q-table class="table-bg" :data="sections" :columns="columns" :filter="filter" :pagination="pagination">
        ...
        <template v-slot:body-cell-Slider-Image="props">
          <q-td :props="props">
            <q-img v-if="props.row.slider_url" :src="`http://api.pediapp.com.ar/images/` + props.row.slider_url" height="auto" width="100px" :ratio="1"/>
          </q-td>
        </template>
        <template v-slot:body-cell-Support-Image="props">
          <q-td :props="props">
            <q-img v-if="props.row.slider_url" :src="`http://api.pediapp.com.ar/images/` + props.row.support_image_url" height="auto" width="100px" :ratio="1"/>
          </q-td>
        </template>
